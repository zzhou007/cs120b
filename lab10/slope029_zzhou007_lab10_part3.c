 ...
 * Lab section 22
 * slope029_zzhou007_lab10_part3.c
 *
...
//sm2 lcd screen 
//prints based on what is pressed
//needs to be pressed and released
//character stays pressed 
enum sm2_States{sm2wait, sm2press, sm2release};
